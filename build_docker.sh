...
# VER=0.1.0 && pushd _build/docker/Release && tar -czvf MinimalGetOpenGLVersion.v${VER}.manylinux.tar.gz GetOpenGLVersion && popd && mv _build/docker/Release/MinimalGetOpenGLVersion.v${VER}.manylinux.tar.gz .
